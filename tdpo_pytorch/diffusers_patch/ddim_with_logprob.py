# This made the following modifications to the original DDIMScheduler from diffusers.schedulers:
...
def ddim_step_with_logprob(
    ...
    Args:
        self ('DDIMScheduler'): original DDIMScheduler from diffusers.schedulers.
